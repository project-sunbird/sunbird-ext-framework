...
export class ElasticSearchDB {
  ...
  public static getConnection(pluginId: string, proxy?: boolean): IElasticSearchConnector {
    ...
    ElasticSearchDB._client = ElasticSearchDB._client || ElasticSearchDB.proxyMethodCalls(new elasticsearch.Client(ElasticSearchDB._config), ElasticSearchDB._config.disabledApis);
    return ElasticSearchDB._client;
  }

  private static proxyMethodCalls(obj: IElasticSearchConnector, disabledAPIs: Array<string>) {
    let handler = {
